...
// 是否裁剪为圆形
let roundedCrop = false;
let index = 0;


const fileUploadBox = document.querySelector(".file-upload-box");
const saveBtn = document.querySelector("#save");
const changeCircle = document.querySelector("#circle");
const previews = document.querySelectorAll(".preview");
const showImages = document.querySelector("#showArea");
const s = document.querySelector("#square");
const b = document.querySelector("#ball");
const p = document.querySelector("#pen");
let previewReady = false;
let croppable = false;

document.addEventListener("UniAppJSBridgeReady", Init);
changeCircle.addEventListener("click",changetoNext);
  ...
  image.onload = function () {
    const options = {
      ...
      ready: function () {
		...
		changeCircle.classList.remove("disabled");
